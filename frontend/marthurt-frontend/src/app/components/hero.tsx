		...
		<>
			<section className='relative h-screen flex items-center justify-center bg-black bg-opacity-50 m-0 p-0'>
				...
				<div className='text-center'>
					...
					<Button className='mt-6 px-6 py-3 bg-white text-black text-lg font-semibold rounded-lg shadow-md hover:bg-gray-200 hover:text-gray-900 transition duration-300'>
						zobacz nowości
					</Button>
				</div>
			</section>
