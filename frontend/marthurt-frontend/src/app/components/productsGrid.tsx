...
const ProductsGrid: React.FC = () => {
  ...
  const { sortBy, sortAscending, setSortBy, toggleSortDirection } = useSortStore();
  ...
  useEffect(() => {
    ...
    fetchProducts();
  }, [filtersApplied, sortBy, sortAscending]);
  ...
  return (
    <main className='xl:px-52 px-5'>
      <div className='flex gap-x-5 mb-5 items-center'>
        <Filter />
        <div className='flex-grow' /> {/* Placeholder for alignment */}
        <Sort /> {/* Sort component moved here */}
