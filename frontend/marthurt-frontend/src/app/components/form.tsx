        ...
        <tbody>
          {formData.map((item, index) => (
            <tr key={index}>
              ...
              <td className='border border-gray-300 p-2 text-center'>{item.bruttoPrice}</td>
              <td className='border border-gray-300 p-2 text-center'>{item.bruttoPriceWithDiscount}</td>
