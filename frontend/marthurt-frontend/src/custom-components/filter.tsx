...
const Filter: React.FC = () => {
	const { priceFrom, priceTo, setPriceFrom, setPriceTo, applyFilters } = useFilterStore()
	...
	return (
		<Sheet>
			...
			<SheetContent side={windowSize.width <= 768 ? 'bottom' : 'left'} className='flex flex-col h-screen'>
				<SheetHeader>
